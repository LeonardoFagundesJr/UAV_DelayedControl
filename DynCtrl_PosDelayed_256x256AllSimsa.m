...
for ii = 1:length(MAPA)
    ...
    % Métricas
    erro_instavel = 5;
    IAE_naoAtrasado = 5.3218;
    ITAE_naoAtrasado = 7.3256;
    ...
    % =========================================================================
    acc_max = 0.0; % Tarefa de posicionamento
    acc_des = acc_max;
...
legend([pC1 pC2 pC3 pC4],{'$max(\tilde{\textbf{d}}) < 5~m$','$$IAE \leq 30~IAE_{sem-atraso}$$',...
